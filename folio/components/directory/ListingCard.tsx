...
export default function ListingCard({ listing }: { listing: PublishedListing }) {
  return (
    <Link
      ...
      className="group flex flex-col p-5 h-full rounded-2xl border border-white/[0.07] bg-bg-card hover:border-white/[0.16] transition-all duration-300 hover:-translate-y-1"
    >
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          {/* Only the name shares a line with the corner bookmark. */}
